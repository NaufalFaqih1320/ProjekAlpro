...
void menuUtama(int UserID)
{
    ...
    do
    {
        ...
        case 3:
            ...
            break;
        case 4:
            riwayat(user1[UserID - 1].mutasi, user1[UserID - 1].mutasi_count);
            nabil = false;
            break;
        case 5:
            dataUser(UserID);
...
void setor(int UserID)
{
    ...
    if (jumlah > 0)
    {
        ...
        user1[UserID - 1].mutasi[user1[UserID - 1].mutasi_count++] = "Setor tunai: +" + to_string(jumlah);
...
void tarik(int UserID)
{
    ...
    if (jumlah <= user1[UserID - 1].balance)
    {
        balance[UserID - 1] -= jumlah;
        user1[UserID - 1].balance = balance[UserID - 1];
        user1[UserID - 1].mutasi[user1[UserID - 1].mutasi_count++] = "Tarik tunai: -" + to_string(jumlah);
